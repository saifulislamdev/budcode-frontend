...
export default function Feed() {
    ...
    const handleAddUpdate = () => {
        const { projectId, projectName } = projectData.find((item) => item.projectId === parseInt(updateInput.project));
            ...
            <div className="feed-content">
                <div className="feed-fields">
                    <div className="project-input-fields">
                        ...
                        <button className="btn btn-primary form-element" onClick={handleAddUpdate}>
                            Post
                        </button>
                    </div>
